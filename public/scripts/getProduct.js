...
async function setProductCheckout() {
    ...
    if (window.location.pathname.endsWith('buy-listing')) {
        ...
        document.getElementById('success-info').innerHTML = `Thank you for your purchase! <br> You have successfully purchased ${product.units}x ${product.name} for ${product.price / 100} DKK.`;
    }
}
