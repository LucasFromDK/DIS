...
(4, "Vintage Typewriter", "Works perfectly, just needs a little cleaning", 25000, 2),
(2, "Handmade Leather Wallet", "Crafted from genuine leather, perfect for everyday use", 49900, 5),
(4, "Retro Vinyl Record Player", "Plays all your favorite LP records with a warm sound", 120000, 3);